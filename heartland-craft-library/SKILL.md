...
### `references/humanizing-fiction-revision.md`
**Use when:** doing a humanization pass on any chapter; auditing AI-default prose fingerprints; structural re-read post-draft.
**Relevant roles:** Series Writer (every chapter), Line/Copy Editor (during line pass), Developmental Editor (structural AI-tells), Editor-in-Chief (ship/no-ship audit).
**The bar:** every shipped chapter must pass the humanizing-fiction discipline — deliberate imperfection, authorial tics, varied paragraph length, no AI-tells (em-dash abuse, tricolons, "not just X but Y", paragraph-length homogeneity, "a testament to").

### `references/character-architecture.md`
**Use when:** building a new major character; auditing an existing character for depth; onboarding a new Series Writer to the character bible philosophy.
**Relevant roles:** Series Writer (creating secondary characters within outline authority), Editor-in-Chief (canon ratification), Developmental Editor (character-arc notes).
**How to apply:** run every recurring named character through this 12-layer architecture pass before they appear in a book. Gaps become bible entries.
...
**Relevant roles:** Series Writer (voice calibration), Developmental Editor (scoping craft standards in the editorial letter), Editor-in-Chief (onboarding new writers).
**How to apply:** comprehensive prompt-format framework covering human-authentic voice, emotional authenticity, language craft, structure, world-building, theme, and revision.
...
- Not a replacement for the series bible.
- Not a replacement for direct reading of the canonical source material on JAS-4.
- Not a license to over-apply frameworks at the expense of voice.
